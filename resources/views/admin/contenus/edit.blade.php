<x-admin-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-slate-800 leading-tight">
            Éditer le contenu : "{{ $contenu->titre }}"
        </h2>
    </x-slot>
            ...
            <div class="card p-6">
                <form action="{{ route('contenus.update', $contenu) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="titre" id="titre" value="{{ old('titre', $contenu->titre) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="url" name="lien_ressource" id="lien_ressource" value="{{ old('lien_ressource', $contenu->lien_ressource) }}"
                               placeholder="https://..."
                               class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('sous_chapitres.contenus.index', $contenu->sous_chapitre_id) }}" class="text-slate-600 underline">Annuler</a>
                    </div>
                </form>
            </div>
        </div>
